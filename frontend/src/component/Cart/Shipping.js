...
import './Shipping.css';
import { saveShipppingInfo } from '../../actions/cartAction';
...
const Shipping = () => {
    ...
    const shippingSubmit = (e) => {
        ...
        dispatch(saveShipppingInfo({ address, city, state, country, pincode, phoneNo }));
            ...
            <div className="shippingContainer">
                <div className="shippingBox">
                    ...
                    <form className='shippingForm' encType='multipart/form-data' onSubmit={shippingSubmit}>
                        ...
                        <div>
                            <PhoneIcon />
                            <input type="number" placeholder="Phone Number" required value={phoneNo} size="10" onChange={(e) => setPhoneNo(e.target.value)} />
                        </div>
                        <div>
                            <PublicIcon />
