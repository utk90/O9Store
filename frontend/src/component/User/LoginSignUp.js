...
const LoginSignUp = () => {
    ...
    const { loading, user: userData, error, isAuthenticated } = useSelector(state => state.user);
                        ...
                        <div className="LoginSignUpBox">
                            ...
                            >
                                ...
                                <div id='registerImage'>
                                    ...
                                    <input type="file" placeholder='avatar' name='avatar' accept='image/*' onChange={registerDataChange} />
                                </div>
